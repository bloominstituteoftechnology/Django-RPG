...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '0.0.0.0', 'jingle-django-rpg.herokuapp.com']
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://efktfidu:c_ew_meEhTwpXuItCGHqteHvmjR4oi2j@baasu.db.elephantsql.com:5432/efktfidu'
    )
}
